...
const LoginButton = () => {
  ...
  return (
    <>
      ...
      {show && (
        <div
          className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center transition-all"
          onClick={handleClose}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 w-72 max-w-sm shadow-2xl border border-white/20 transition-all"
          >
