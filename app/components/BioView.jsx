        ...
        <div className="flex justify-center gap-5 items-center">
          ...
          <div className="grid gap-3">
            <span className="border-b pb-1 border-gray-700 flex text-left">
              {bio.username || <span className="text-gray-500">Add username</span>}
            </span>
            <span className="border-b pb-1 border-gray-700 flex justify-start">
              {bio.job || <span className="text-gray-500">Add job</span>}
            </span>
            <span className="border-b pb-1 border-gray-700 flex justify-start">
              {bio.location || <span className="text-gray-500">Add location</span>}
            </span>
            <span className="border-b pb-1 border-gray-700 flex justify-start">
            ...
            <span className="border-b pb-1 border-gray-700 flex justify-start">
              {bio.bio ? `${bio.bio.split(" ").slice(0, 2).join(" ")}...` : <span className="text-gray-500">Add bio</span>}
            </span>
          </div>
        </div>
      )}
