...
export const TopBar = () => {
  return (
    <div className=" flex justify-center gap-2 h-6 bg-[linear-gradient(90deg,_rgba(10,228,72,1)_0%,_rgba(171,255,132,1)_100%)]">
      <div>
        <svg
      ...
      <div className="Poppins  text-xs flex justify-center pt-1 tracking-tighter">
        dimple is now free for everyone, thanks for support!
      </div>
    </div>
  );
};
